...
listResponseEntityFromJson(ListResponseEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new ListResponseData().fromJson(json['data']);
	}
...
listResponseDataFromJson(ListResponseData data, Map<String, dynamic> json) {
	if (json['curPage'] != null) {
		data.curPage = json['curPage']?.toInt();
	}
	if (json['datas'] != null) {
		data.datas = new List<ListResponseDataData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new ListResponseDataData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> listResponseDataToJson(ListResponseData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
listResponseDataDataFromJson(ListResponseDataData data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ListResponseDataDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ListResponseDataDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
Map<String, dynamic> listResponseDataDataToJson(ListResponseDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
listResponseDataDatasTagFromJson(ListResponseDataDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> listResponseDataDatasTagToJson(ListResponseDataDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
